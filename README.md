...
Arline benchmarking platform has been recently used by Oxford Quantum Circuits team (see ![blog post](https://oxfordquantumcircuits.com/oqc-integrates-tket)) for compiler performance testing.
